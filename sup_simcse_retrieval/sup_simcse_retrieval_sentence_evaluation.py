...
def convert_to_features(tokenizer, in_file, max_seq_length, metrics, max_h_sens, max_evi_sens):
    ...
    retrieval_model = RobertaModel.from_pretrained(r"sup-simcse-roberta-base").cuda()
    retrieval_tokenzier = RobertaTokenizer.from_pretrained(r"sup-simcse-roberta-base")
